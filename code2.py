...
def boot_instance():
    ...
    instance_boot=nova.servers.create(name="instance1", image=boot_image, 
                                     flavor=boot_flav, network=boot_subnet)
...
"""
def ipsec_site_conn():
    neutron.create_ipsec_site_connection(body=
                                         "ipsec_site_connection": {
                                               "name": "ipsec_connection_1",
                                               "peer_address": peer_subnet,
                                               "peer_id": peer_subnet,
                                               "peer_cidr": "10.30.2.0/24",
